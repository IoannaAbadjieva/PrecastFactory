namespace PrecastFactorySystem.Infrastructure.Data.Configurations
{
    ...
    internal class PrecastTypeConfiguration : IEntityTypeConfiguration<PrecastType>
    {
     
        public void Configure(EntityTypeBuilder<PrecastType> builder)
        {
            builder
                .HasData(SeedPrecastType());
        }

        private IEnumerable<PrecastType> SeedPrecastType()
        {
            return new PrecastType[]
            {
				new PrecastType()
			{
				Id = 1,
