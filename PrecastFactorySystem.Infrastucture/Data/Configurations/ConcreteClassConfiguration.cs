namespace PrecastFactorySystem.Infrastructure.Data.Configurations
{
	...
	internal class ConcreteClassConfiguration : IEntityTypeConfiguration<ConcreteClass>
	{

		public void Configure(EntityTypeBuilder<ConcreteClass> builder)
		{
			builder
				 .HasData(SeedConcreteClasses());
		}

		private IEnumerable<ConcreteClass> SeedConcreteClasses()
		{
